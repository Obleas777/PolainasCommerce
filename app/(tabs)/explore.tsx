    ...
    >
      ...
      <View style={styles.pageContainer}>
        ...
        <TouchableOpacity style={styles.adminButton}>
          <Text style={styles.adminButtonText}>Administrar Productos</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  navbar: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#232F3E', // Azul oscuro similar al de Amazon
    paddingVertical: 15,
    paddingHorizontal: 20,
    borderBottomWidth: 1,
    borderBottomColor: '#1D1D1D', // Gris oscuro
  },
  logo: {
    width: 40,
    height: 40,
